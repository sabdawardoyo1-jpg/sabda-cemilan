...
function bayar(metode) {
    ...
    if(metode === 'GOPAY'){
        infoPembayaran = `Transfer ke GoPay: 08998628025 a/n Sabda Gusti Nang Wardoyo<br><br><img src="gopay.jpg" style="width:200px; margin:auto; display:block;"><p style="font-size:14px;">Scan QR GoPay di atas</p>`;
    }
    if(metode === 'MANDIRI'){
        infoPembayaran = `Transfer ke Mandiri: 1270011397252 a/n Sabda Gusti Nang Wardoyo<br><br><p style="font-size:14px;">a.n Sabda Gusti Nang Wardoyo</p>`;
    }
